...
$(function () {
    ...
    var dd = d.getDate();
    var hh = d.getHours();
    var mm = d.getMinutes() + 3;
    var ss = d.getSeconds();
    $.ajax({
        url: 'rest/quizzgames',
        type: 'POST',
        data: '{"id":"' + uuidv4() + '","title":"Created by population script","timeBegin":"2017-09-' + dd + ' ' + hh + ':' + mm + ':00","minPlayers":"1","maxPlayers":"4","questions":["739d7730-4495-477c-b4e4-df796572a757","a82f3a14-7f36-4641-a48b-08bc5afda4ef"]}',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        success: function (result) {
